...
public final class LgeCardStatus {
    public final ArrayList<LgeAppStatus> applications = new ArrayList();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != LgeCardStatus.class) {
            return false;
        }
        LgeCardStatus other = (LgeCardStatus) otherObject;
    ...
    public final String toString() {
        ...
        builder.append(LgeCardState.toString(this.cardState));
    ...
    public static final ArrayList<LgeCardStatus> readVectorFromParcel(HwParcel parcel) {
        ArrayList<LgeCardStatus> _hidl_vec = new ArrayList();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 40), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            LgeCardStatus _hidl_vec_element = new LgeCardStatus();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 80), _hidl_blob.handle(), (24 + _hidl_offset) + 0, true);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<LgeCardStatus> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((LgeCardStatus) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 40));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((LgeAppStatus) this.applications.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 80));
        }
