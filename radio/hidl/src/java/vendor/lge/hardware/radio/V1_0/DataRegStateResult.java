...
public final class DataRegStateResult {
    ...
    public final int[] extraInfo = new int[4];
    ...
    public final String toString() {
        ...
        builder.append(Arrays.toString(this.extraInfo));
        builder.append("}");
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        long _hidl_array_offset_0 = _hidl_offset + 104;
        for (int _hidl_index_0_0 = 0; _hidl_index_0_0 < 4; _hidl_index_0_0++) {
            this.extraInfo[_hidl_index_0_0] = _hidl_blob.getInt32(_hidl_array_offset_0);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<DataRegStateResult> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((DataRegStateResult) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 120));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt32(_hidl_offset + 4, this.rat);
        ...
        long _hidl_array_offset_0 = _hidl_offset + 104;
        for (int _hidl_index_0_0 = 0; _hidl_index_0_0 < 4; _hidl_index_0_0++) {
            _hidl_blob.putInt32(_hidl_array_offset_0, this.extraInfo[_hidl_index_0_0]);
            _hidl_array_offset_0 += 4;
        }
    }
}
