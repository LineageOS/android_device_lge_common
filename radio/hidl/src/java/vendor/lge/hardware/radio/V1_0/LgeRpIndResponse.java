...
public final class LgeRpIndResponse {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != LgeRpIndResponse.class) {
            return false;
        }
        LgeRpIndResponse other = (LgeRpIndResponse) otherObject;
        return this.param == other.param && this.data_valid == other.data_valid && this.data_len == other.data_len && HidlSupport.deepEquals(this.data, other.data);
    }

    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.param))), Integer.valueOf(HidlSupport.deepHashCode(Byte.valueOf(this.data_valid))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.data_len))), Integer.valueOf(HidlSupport.deepHashCode(this.data))});
    }
    ...
    public static final ArrayList<LgeRpIndResponse> readVectorFromParcel(HwParcel parcel) {
        ArrayList<LgeRpIndResponse> _hidl_vec = new ArrayList();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 32), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            LgeRpIndResponse _hidl_vec_element = new LgeRpIndResponse();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.data_valid = _hidl_blob.getInt8(4 + _hidl_offset);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<LgeRpIndResponse> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((LgeRpIndResponse) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 32));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt8(4 + _hidl_offset, this.data_valid);
