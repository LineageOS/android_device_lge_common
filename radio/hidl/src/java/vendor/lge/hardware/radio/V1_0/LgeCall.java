...
public final class LgeCall {
    ...
    public String numberplus = new String();
    public int signalIE;
    public int state;
    public int toa;
    ...
    public final String toString() {
        ...
        builder.append(", .numberplus = ");
        builder.append(this.numberplus);
        builder.append(", .signalIE = ");
        builder.append(this.signalIE);
        builder.append("}");
    ...
    public static final ArrayList<LgeCall> readVectorFromParcel(HwParcel parcel) {
        ArrayList<LgeCall> _hidl_vec = new ArrayList();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 112), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            LgeCall _hidl_vec_element = new LgeCall();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.numberplus = _hidl_blob.getString(88 + _hidl_offset);
        parcel.readEmbeddedBuffer((long) (this.numberplus.getBytes().length + 1), _hidl_blob.handle(), (88 + _hidl_offset) + 0, false);
        this.signalIE = _hidl_blob.getInt32(104 + _hidl_offset);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<LgeCall> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((LgeCall) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 112));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putString(88 + _hidl_offset, this.numberplus);
        _hidl_blob.putInt32(104 + _hidl_offset, this.signalIE);
    }
}
