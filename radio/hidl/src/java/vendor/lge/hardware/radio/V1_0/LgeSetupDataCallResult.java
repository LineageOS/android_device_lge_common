...
public final class LgeSetupDataCallResult {
    public int active;
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != LgeSetupDataCallResult.class) {
            return false;
        }
        LgeSetupDataCallResult other = (LgeSetupDataCallResult) otherObject;
    ...
    public static final ArrayList<LgeSetupDataCallResult> readVectorFromParcel(HwParcel parcel) {
        ArrayList<LgeSetupDataCallResult> _hidl_vec = new ArrayList();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 120), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            LgeSetupDataCallResult _hidl_vec_element = new LgeSetupDataCallResult();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<LgeSetupDataCallResult> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((LgeSetupDataCallResult) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 120));
        }
