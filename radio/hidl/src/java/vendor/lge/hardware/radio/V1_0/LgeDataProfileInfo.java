...
public final class LgeDataProfileInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != LgeDataProfileInfo.class) {
            return false;
        }
        LgeDataProfileInfo other = (LgeDataProfileInfo) otherObject;
    ...
    public static final ArrayList<LgeDataProfileInfo> readVectorFromParcel(HwParcel parcel) {
        ArrayList<LgeDataProfileInfo> _hidl_vec = new ArrayList();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 152), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            LgeDataProfileInfo _hidl_vec_element = new LgeDataProfileInfo();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<LgeDataProfileInfo> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((LgeDataProfileInfo) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 152));
        }
